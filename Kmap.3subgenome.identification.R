...
assign(paste("my.chr.dat.",i,sep=""),rownames(subset(my.iter,(my.iter[,1]/my.iter[,2])>=10 | (my.iter[,1]/my.iter[,2])<=1/10) | (my.iter[,1]/my.iter[,3)<=1/10) | (my.iter[,1]/my.iter[,3])>=10) | (my.iter[,2]/my.iter[,3)<=1/10) | (my.iter[,2]/my.iter[,3])>=10)  ));
}
