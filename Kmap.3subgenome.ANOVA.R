...
GC.tukey<-matrix(nrow=length(rownames(csa.norm)),ncol=14);
colnames(GC.tukey)<-c("Group.df","Group.Sumsq","Group.MeanSq","Residual.df","Residual.Sumsq","Residual.MeanSq","Fvalue","Pr","Sub2-Sub1.diff","Sub2-Sub1.p","Sub3-Sub1.diff","Sub3-Sub1.p","Sub3-Sub2.diff","Sub3-Sub2.p");
...
GC.tukey[i,13]<-TukeyHSD(my.aov)$Group["Sub3-Sub2","diff"];GC.tukey[i,14]<-TukeyHSD(my.aov)$Group["Sub3-Sub2","p adj"];
